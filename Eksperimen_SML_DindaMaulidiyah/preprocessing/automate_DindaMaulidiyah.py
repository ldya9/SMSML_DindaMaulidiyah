...
if __name__ == "__main__":
    ...
    # Input: dataset raw dari folder RedWine_raw
    input_path = os.path.join(script_dir, '..', 'RedWine_raw', 'winequality-red.csv')
    
    # Output: dataset preprocessed ke folder WineRed_preprocessing
